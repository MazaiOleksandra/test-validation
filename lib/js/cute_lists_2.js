...
function EnvTextListEx(list_selector, max_shown)
{
    ...
    n_container
            ...
            .insertBefore(obj)
            .append("<center style='font-size: 8pt; margin: 5px;'>Удерживайте Ctrl для выбора нескольких продуктов</center>")
            .append(
                $('<button type="button" style="width: 100%">ОК</button>')
                    .click(function(){
                        //OK click
                        $(this.parentNode).data().n_link.html(q_option_value($(this.parentNode).data().obj));
    ...
    obj
        ...
        .css('width', '100%')
        .change(function(){
            $(this).data().n_link.html(q_option_value(this)); 
        })
